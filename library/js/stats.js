...
async function loadStats() {
    ...
    try {
        ...
        const statsResponse = await fetch(`${API_BASE}/history.php?action=fullStats&userId=${currentUser.id}`);
        ...
        const borrowedResponse = await fetch(`${API_BASE}/borrow.php?action=list&userId=${currentUser.id}`);
